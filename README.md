## A [Lo](http://lolang.org)-to-JavaScript compiler, written in Node.js. ![https://travis-ci.org/lo-language/velo](https://travis-ci.org/lo-language/velo.svg?branch=master)
