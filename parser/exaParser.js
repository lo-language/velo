...
exaParser.prototype.statement = function() {
    ...
    try {
        ...
        case 2:
            ...
            this.state = 63;
            _la = this._input.LA(1);
            if((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << exaParser.T__18) | (1 << exaParser.T__20) | (1 << exaParser.T__21) | (1 << exaParser.T__22) | (1 << exaParser.T__23))) !== 0) || ((((_la - 40)) & ~0x1f) == 0 && ((1 << (_la - 40)) & ((1 << (exaParser.T__39 - 40)) | (1 << (exaParser.T__46 - 40)) | (1 << (exaParser.BEGIN - 40)) | (1 << (exaParser.NIL - 40)) | (1 << (exaParser.BOOL - 40)) | (1 << (exaParser.NUMBER - 40)) | (1 << (exaParser.ID - 40)) | (1 << (exaParser.STRING - 40)) | (1 << (exaParser.INTER_BEGIN - 40)))) !== 0)) {
                this.state = 62;
                this.exprList();
            }
...
exaParser.prototype.block = function() {
    ...
    try {
        ...
        this.state = 112;
        _la = this._input.LA(1);
        if((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << exaParser.T__2) | (1 << exaParser.T__3) | (1 << exaParser.T__4) | (1 << exaParser.T__8) | (1 << exaParser.T__16) | (1 << exaParser.T__18) | (1 << exaParser.T__20) | (1 << exaParser.T__21) | (1 << exaParser.T__22) | (1 << exaParser.T__23))) !== 0) || ((((_la - 40)) & ~0x1f) == 0 && ((1 << (_la - 40)) & ((1 << (exaParser.T__39 - 40)) | (1 << (exaParser.T__46 - 40)) | (1 << (exaParser.BEGIN - 40)) | (1 << (exaParser.NIL - 40)) | (1 << (exaParser.BOOL - 40)) | (1 << (exaParser.NUMBER - 40)) | (1 << (exaParser.ID - 40)) | (1 << (exaParser.STRING - 40)) | (1 << (exaParser.INTER_BEGIN - 40)))) !== 0)) {
            this.state = 111;
            this.statementList();
        }
...
exaParser.prototype.pairList = function() {
    ...
    try {
        ...
        do {
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
        } while((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << exaParser.T__18) | (1 << exaParser.T__20) | (1 << exaParser.T__21) | (1 << exaParser.T__22) | (1 << exaParser.T__23))) !== 0) || ((((_la - 40)) & ~0x1f) == 0 && ((1 << (_la - 40)) & ((1 << (exaParser.T__39 - 40)) | (1 << (exaParser.T__46 - 40)) | (1 << (exaParser.BEGIN - 40)) | (1 << (exaParser.NIL - 40)) | (1 << (exaParser.BOOL - 40)) | (1 << (exaParser.NUMBER - 40)) | (1 << (exaParser.ID - 40)) | (1 << (exaParser.STRING - 40)) | (1 << (exaParser.INTER_BEGIN - 40)))) !== 0));
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
	        localctx.exception = re;
	        this._errHandler.reportError(this, re);
