...
loParser.prototype.statement = function() {
    ...
    try {
        ...
        case 2:
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
            if(((((_la - 15)) & ~0x1f) == 0 && ((1 << (_la - 15)) & ((1 << (loParser.T__14 - 15)) | (1 << (loParser.T__28 - 15)) | (1 << (loParser.T__29 - 15)) | (1 << (loParser.T__36 - 15)) | (1 << (loParser.T__37 - 15)))) !== 0) || ((((_la - 54)) & ~0x1f) == 0 && ((1 << (_la - 54)) & ((1 << (loParser.T__53 - 54)) | (1 << (loParser.T__57 - 54)) | (1 << (loParser.BEGIN - 54)) | (1 << (loParser.NIL - 54)) | (1 << (loParser.BOOL - 54)) | (1 << (loParser.NUMBER - 54)) | (1 << (loParser.ASYNC - 54)) | (1 << (loParser.ID - 54)) | (1 << (loParser.STRING - 54)) | (1 << (loParser.INTER_BEGIN - 54)))) !== 0)) {
                this.state = 61;
                this.exprList();
            }
...
loParser.prototype.block = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << loParser.T__0) | (1 << loParser.T__1) | (1 << loParser.T__2) | (1 << loParser.T__14) | (1 << loParser.T__16) | (1 << loParser.T__19) | (1 << loParser.T__20) | (1 << loParser.T__26) | (1 << loParser.T__28) | (1 << loParser.T__29))) !== 0) || ((((_la - 37)) & ~0x1f) == 0 && ((1 << (_la - 37)) & ((1 << (loParser.T__36 - 37)) | (1 << (loParser.T__37 - 37)) | (1 << (loParser.T__53 - 37)) | (1 << (loParser.T__57 - 37)) | (1 << (loParser.BEGIN - 37)) | (1 << (loParser.NIL - 37)) | (1 << (loParser.BOOL - 37)) | (1 << (loParser.NUMBER - 37)))) !== 0) || ((((_la - 69)) & ~0x1f) == 0 && ((1 << (_la - 69)) & ((1 << (loParser.ASYNC - 69)) | (1 << (loParser.ID - 69)) | (1 << (loParser.STRING - 69)) | (1 << (loParser.INTER_BEGIN - 69)))) !== 0)) {
            this.state = 184;
            this.statementList();
        }
...
loParser.prototype.memberList = function() {
    ...
    try {
        ...
        do {
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
        } while(((((_la - 15)) & ~0x1f) == 0 && ((1 << (_la - 15)) & ((1 << (loParser.T__14 - 15)) | (1 << (loParser.T__28 - 15)) | (1 << (loParser.T__29 - 15)) | (1 << (loParser.T__36 - 15)) | (1 << (loParser.T__37 - 15)))) !== 0) || ((((_la - 54)) & ~0x1f) == 0 && ((1 << (_la - 54)) & ((1 << (loParser.T__53 - 54)) | (1 << (loParser.T__57 - 54)) | (1 << (loParser.BEGIN - 54)) | (1 << (loParser.NIL - 54)) | (1 << (loParser.BOOL - 54)) | (1 << (loParser.NUMBER - 54)) | (1 << (loParser.ASYNC - 54)) | (1 << (loParser.ID - 54)) | (1 << (loParser.STRING - 54)) | (1 << (loParser.INTER_BEGIN - 54)))) !== 0));
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
	        localctx.exception = re;
	        this._errHandler.reportError(this, re);
