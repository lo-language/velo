...
var literalNames = [ null, "'reply'", "'fail'", "'substitute'", "';'", "'='", 
                     "'+='", "'-='", "'*='", "'/='", "'%='", "'++'", "'--'", 
                     "'+>'", "'<+'", "'('", "')'", "'on'", "'<-'", "'while'", 
                     "'scan'", "'is'", "'are'", "'module'", "'::'", "'if'", 
                     "'else'", "'#'", "'['", "']'", "'..'", "'.'", "'exists'", 
                     "'defined'", "'undefined'", "'not'", "'bytes'", "'*'", 
                     "'/'", "'%'", "'+'", "'-'", "'<'", "'>'", "'<='", "'>='", 
                     "'=='", "'!='", "'and'", "'or'", "'has'", "'contains'", 
                     "'`'", "','", "'?'", "'><'", "'<->'", "'-<'", "'->'", 
...
var symbolicNames = [ null, null, null, null, null, null, null, null, null, 
                      ...
                      "FIELD_SEP", "NUMBER", "ASYNC", "AWAIT", "ID", "STRING", 
...
loParser.ID = 71;
loParser.STRING = 72;
loParser.INTER_BEGIN = 73;
loParser.INTER_MID = 74;
loParser.INTER_END = 75;
...
loParser.prototype.statement = function() {
    ...
    try {
        ...
        case 2:
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
            if(((((_la - 15)) & ~0x1f) == 0 && ((1 << (_la - 15)) & ((1 << (loParser.T__14 - 15)) | (1 << (loParser.T__23 - 15)) | (1 << (loParser.T__26 - 15)) | (1 << (loParser.T__27 - 15)) | (1 << (loParser.T__34 - 15)) | (1 << (loParser.T__35 - 15)))) !== 0) || ((((_la - 52)) & ~0x1f) == 0 && ((1 << (_la - 52)) & ((1 << (loParser.T__51 - 52)) | (1 << (loParser.T__55 - 52)) | (1 << (loParser.T__56 - 52)) | (1 << (loParser.T__57 - 52)) | (1 << (loParser.BEGIN - 52)) | (1 << (loParser.NIL - 52)) | (1 << (loParser.BOOL - 52)) | (1 << (loParser.NUMBER - 52)) | (1 << (loParser.ASYNC - 52)) | (1 << (loParser.ID - 52)) | (1 << (loParser.STRING - 52)) | (1 << (loParser.INTER_BEGIN - 52)))) !== 0)) {
                this.state = 61;
                this.exprList();
            }
        ...
        case 9:
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
            if(_la===loParser.T__16 || _la===loParser.T__57) {
                this.state = 101;
                this.handlers();
            }
...
loParser.prototype.definition = function() {
    ...
    try {
        ...
        this.state = 117;
        _la = this._input.LA(1);
        if(!(_la===loParser.T__20 || _la===loParser.T__21)) {
...
loParser.prototype.block = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << loParser.T__0) | (1 << loParser.T__1) | (1 << loParser.T__2) | (1 << loParser.T__14) | (1 << loParser.T__16) | (1 << loParser.T__18) | (1 << loParser.T__19) | (1 << loParser.T__23) | (1 << loParser.T__24) | (1 << loParser.T__26) | (1 << loParser.T__27))) !== 0) || ((((_la - 35)) & ~0x1f) == 0 && ((1 << (_la - 35)) & ((1 << (loParser.T__34 - 35)) | (1 << (loParser.T__35 - 35)) | (1 << (loParser.T__51 - 35)) | (1 << (loParser.T__55 - 35)) | (1 << (loParser.T__56 - 35)) | (1 << (loParser.T__57 - 35)) | (1 << (loParser.BEGIN - 35)) | (1 << (loParser.NIL - 35)) | (1 << (loParser.BOOL - 35)))) !== 0) || ((((_la - 68)) & ~0x1f) == 0 && ((1 << (_la - 68)) & ((1 << (loParser.NUMBER - 68)) | (1 << (loParser.ASYNC - 68)) | (1 << (loParser.ID - 68)) | (1 << (loParser.STRING - 68)) | (1 << (loParser.INTER_BEGIN - 68)))) !== 0)) {
            this.state = 169;
            this.statementList();
        }
        ...
        while(_alt!=2 && _alt!=antlr4.atn.ATN.INVALID_ALT_NUMBER) {
            if(_alt===1) {
                ...
                case 1:
                    ...
                    localctx.op = this._input.LT(1);
                    _la = this._input.LA(1);
                    if(!(((((_la - 37)) & ~0x1f) == 0 && ((1 << (_la - 37)) & ((1 << (loParser.T__36 - 37)) | (1 << (loParser.T__37 - 37)) | (1 << (loParser.T__38 - 37)))) !== 0))) {
                        localctx.op = this._errHandler.recoverInline(this);
                    }
                    else {
                    	this._errHandler.reportMatch(this);
                ...
                case 3:
                    ...
                    localctx.op = this._input.LT(1);
                    _la = this._input.LA(1);
                    if(!(((((_la - 42)) & ~0x1f) == 0 && ((1 << (_la - 42)) & ((1 << (loParser.T__41 - 42)) | (1 << (loParser.T__42 - 42)) | (1 << (loParser.T__43 - 42)) | (1 << (loParser.T__44 - 42)) | (1 << (loParser.T__45 - 42)) | (1 << (loParser.T__46 - 42)))) !== 0))) {
                        localctx.op = this._errHandler.recoverInline(this);
                    }
                    else {
                    	this._errHandler.reportMatch(this);
                ...
                case 12:
                    ...
                    localctx.op = this._input.LT(1);
                    _la = this._input.LA(1);
                    if(!(((((_la - 32)) & ~0x1f) == 0 && ((1 << (_la - 32)) & ((1 << (loParser.T__31 - 32)) | (1 << (loParser.T__32 - 32)) | (1 << (loParser.T__33 - 32)))) !== 0))) {
                        localctx.op = this._errHandler.recoverInline(this);
                    }
                    else {
                    	this._errHandler.reportMatch(this);
...
loParser.prototype.pairList = function() {
    ...
    try {
        ...
        do {
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
        } while(((((_la - 15)) & ~0x1f) == 0 && ((1 << (_la - 15)) & ((1 << (loParser.T__14 - 15)) | (1 << (loParser.T__23 - 15)) | (1 << (loParser.T__26 - 15)) | (1 << (loParser.T__27 - 15)) | (1 << (loParser.T__34 - 15)) | (1 << (loParser.T__35 - 15)))) !== 0) || ((((_la - 52)) & ~0x1f) == 0 && ((1 << (_la - 52)) & ((1 << (loParser.T__51 - 52)) | (1 << (loParser.T__55 - 52)) | (1 << (loParser.T__56 - 52)) | (1 << (loParser.T__57 - 52)) | (1 << (loParser.BEGIN - 52)) | (1 << (loParser.NIL - 52)) | (1 << (loParser.BOOL - 52)) | (1 << (loParser.NUMBER - 52)) | (1 << (loParser.ASYNC - 52)) | (1 << (loParser.ID - 52)) | (1 << (loParser.STRING - 52)) | (1 << (loParser.INTER_BEGIN - 52)))) !== 0));
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
	        localctx.exception = re;
	        this._errHandler.reportError(this, re);
