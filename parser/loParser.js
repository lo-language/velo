...
loParser.prototype.definition = function() {
    ...
    try {
        ...
        this.state = 105;
        _la = this._input.LA(1);
        if(!(_la===loParser.T__13 || _la===loParser.T__14)) {
...
loParser.prototype.assignment_op = function() {
    ...
    try {
        ...
        this.state = 123;
        _la = this._input.LA(1);
        if(!((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << loParser.T__15) | (1 << loParser.T__16) | (1 << loParser.T__17) | (1 << loParser.T__18) | (1 << loParser.T__19) | (1 << loParser.T__20))) !== 0))) {
        this._errHandler.recoverInline(this);
        }
        else {
        	this._errHandler.reportMatch(this);
...
loParser.prototype.block = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << loParser.T__0) | (1 << loParser.T__1) | (1 << loParser.T__2) | (1 << loParser.T__6) | (1 << loParser.T__8) | (1 << loParser.T__9) | (1 << loParser.T__11) | (1 << loParser.T__12) | (1 << loParser.T__21) | (1 << loParser.T__23) | (1 << loParser.T__24) | (1 << loParser.T__25))) !== 0) || ((((_la - 46)) & ~0x1f) == 0 && ((1 << (_la - 46)) & ((1 << (loParser.T__45 - 46)) | (1 << (loParser.T__46 - 46)) | (1 << (loParser.T__51 - 46)) | (1 << (loParser.T__52 - 46)) | (1 << (loParser.T__53 - 46)) | (1 << (loParser.T__54 - 46)) | (1 << (loParser.BEGIN - 46)) | (1 << (loParser.NIL - 46)) | (1 << (loParser.BOOL - 46)) | (1 << (loParser.NUMBER - 46)) | (1 << (loParser.ID - 46)) | (1 << (loParser.STRING - 46)) | (1 << (loParser.INTER_BEGIN - 46)))) !== 0)) {
            this.state = 144;
            this.statementList();
        }
...
function PushFrontContext(parser, ctx) {
	ExprContext.call(this, parser);
    ExprContext.prototype.copyFrom.call(this, ctx);
    return this;
}

PushFrontContext.prototype = Object.create(ExprContext.prototype);
PushFrontContext.prototype.constructor = PushFrontContext;

loParser.PushFrontContext = PushFrontContext;

PushFrontContext.prototype.expr = function(i) {
    if(i===undefined) {
        i = null;
    }
    if(i===null) {
...
PushFrontContext.prototype.accept = function(visitor) {
    if ( visitor instanceof loVisitor ) {
        return visitor.visitPushFront(this);
    } else {
        return visitor.visitChildren(this);
    }
};
...
function PushBackContext(parser, ctx) {
	ExprContext.call(this, parser);
    ExprContext.prototype.copyFrom.call(this, ctx);
    return this;
}

PushBackContext.prototype = Object.create(ExprContext.prototype);
PushBackContext.prototype.constructor = PushBackContext;

loParser.PushBackContext = PushBackContext;

PushBackContext.prototype.expr = function(i) {
    if(i===undefined) {
        i = null;
    }
    if(i===null) {
...
PushBackContext.prototype.accept = function(visitor) {
    if ( visitor instanceof loVisitor ) {
        return visitor.visitPushBack(this);
    } else {
        return visitor.visitChildren(this);
    }
};
        ...
        while(_alt!=2 && _alt!=antlr4.atn.ATN.INVALID_ALT_NUMBER) {
            if(_alt===1) {
                ...
                case 1:
                    ...
                    localctx.op = this._input.LT(1);
                    _la = this._input.LA(1);
                    if(!((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << loParser.T__26) | (1 << loParser.T__27) | (1 << loParser.T__28))) !== 0))) {
                        localctx.op = this._errHandler.recoverInline(this);
                    }
                    else {
                    	this._errHandler.reportMatch(this);
                ...
                case 2:
                    ...
                    localctx.op = this._input.LT(1);
                    _la = this._input.LA(1);
                    if(!(_la===loParser.T__29 || _la===loParser.T__30)) {
                        localctx.op = this._errHandler.recoverInline(this);
                    }
                    else {
                    	this._errHandler.reportMatch(this);
                ...
                case 3:
                    ...
                    localctx.op = this._input.LT(1);
                    _la = this._input.LA(1);
                    if(!(((((_la - 32)) & ~0x1f) == 0 && ((1 << (_la - 32)) & ((1 << (loParser.T__31 - 32)) | (1 << (loParser.T__32 - 32)) | (1 << (loParser.T__33 - 32)) | (1 << (loParser.T__34 - 32)) | (1 << (loParser.T__35 - 32)) | (1 << (loParser.T__36 - 32)))) !== 0))) {
                        localctx.op = this._errHandler.recoverInline(this);
                    }
                    else {
                    	this._errHandler.reportMatch(this);
                ...
                case 8:
                    localctx = new PushFrontContext(this, new ExprContext(this, _parentctx, _parentState));
                    this.pushNewRecursionContext(localctx, _startState, loParser.RULE_expr);
                    this.state = 218;
                ...
                case 9:
                    localctx = new PushBackContext(this, new ExprContext(this, _parentctx, _parentState));
                    this.pushNewRecursionContext(localctx, _startState, loParser.RULE_expr);
                    this.state = 221;
...
loParser.prototype.pairList = function() {
    ...
    try {
        ...
        do {
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
        } while((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << loParser.T__6) | (1 << loParser.T__8) | (1 << loParser.T__23) | (1 << loParser.T__24) | (1 << loParser.T__25))) !== 0) || ((((_la - 46)) & ~0x1f) == 0 && ((1 << (_la - 46)) & ((1 << (loParser.T__45 - 46)) | (1 << (loParser.T__46 - 46)) | (1 << (loParser.T__51 - 46)) | (1 << (loParser.T__52 - 46)) | (1 << (loParser.T__53 - 46)) | (1 << (loParser.T__54 - 46)) | (1 << (loParser.BEGIN - 46)) | (1 << (loParser.NIL - 46)) | (1 << (loParser.BOOL - 46)) | (1 << (loParser.NUMBER - 46)) | (1 << (loParser.ID - 46)) | (1 << (loParser.STRING - 46)) | (1 << (loParser.INTER_BEGIN - 46)))) !== 0));
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
	        localctx.exception = re;
	        this._errHandler.reportError(this, re);
