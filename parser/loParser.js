...
loParser.T__51 = 52;
loParser.WS = 53;
loParser.LINE_COMMENT = 54;
loParser.COMMENT = 55;
loParser.BEGIN = 56;
loParser.END = 57;
loParser.NIL = 58;
loParser.BOOL = 59;
loParser.PAIR_SEP = 60;
loParser.FIELD_SEP = 61;
loParser.NUMBER = 62;
loParser.ID = 63;
loParser.STRING = 64;
loParser.INTER_BEGIN = 65;
loParser.INTER_MID = 66;
loParser.INTER_END = 67;
...
loParser.prototype.statement = function() {
    ...
    try {
        ...
        case 2:
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
            if((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << loParser.T__6) | (1 << loParser.T__8) | (1 << loParser.T__22) | (1 << loParser.T__23) | (1 << loParser.T__24))) !== 0) || ((((_la - 43)) & ~0x1f) == 0 && ((1 << (_la - 43)) & ((1 << (loParser.T__42 - 43)) | (1 << (loParser.T__43 - 43)) | (1 << (loParser.T__48 - 43)) | (1 << (loParser.T__49 - 43)) | (1 << (loParser.T__50 - 43)) | (1 << (loParser.T__51 - 43)) | (1 << (loParser.BEGIN - 43)) | (1 << (loParser.NIL - 43)) | (1 << (loParser.BOOL - 43)) | (1 << (loParser.NUMBER - 43)) | (1 << (loParser.ID - 43)) | (1 << (loParser.STRING - 43)) | (1 << (loParser.INTER_BEGIN - 43)))) !== 0)) {
                this.state = 53;
                this.exprList();
            }
